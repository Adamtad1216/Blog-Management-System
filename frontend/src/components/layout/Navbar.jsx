        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-lg tracking-tight gradient-text">BlogCraft</span>
              <span className="text-[10px] text-slate-400 -mt-1 font-medium tracking-widest uppercase">Content Hub</span>
            </div>
          </Link>
          ...
          <form onSubmit={handleSearchSubmit} className="hidden md:flex items-center relative max-w-xs w-full">
            ...
            />
            <svg className="w-4 h-4 text-slate-500 absolute left-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <nav className="flex items-center gap-1 sm:gap-3">
            <NavLink
              ...
              className={({ isActive }) =>
                `px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${isActive ? 'text-indigo-400 bg-indigo-500/10' : 'text-slate-300 hover:text-white hover:bg-slate-800/50'
                }`
              }
            >
              Home
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-3 pl-2 border-l border-slate-800 ml-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="hidden lg:inline text-xs font-bold text-slate-200">{user?.fullName}</span>
                </div>
